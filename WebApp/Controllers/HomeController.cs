...
namespace WebApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ILogger<HomeController> logger, IUnitOfWork unitOfWork, InMemoryDataContext dataContext, AuthService authService)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var classes = _dataContext.Classes;
            var instructors = _dataContext.Instructors;
            var grades = _dataContext.Grades;
            ...
            var departmentSummaries = departments
                .Select(d => new DepartmentSummary
                {
                    ...
                    StudentCount = students.Count(s => s.DepartmentId == d.Id || s.Major.Equals(d.Name, StringComparison.OrdinalIgnoreCase)),
